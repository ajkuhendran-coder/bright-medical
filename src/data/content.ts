...
export const processSteps = [
  {
    ...
    description: 'Sie füllen einen kurzen Fragebogen aus. So prüfen wir gemeinsam, ob das Coaching-Programm zu Ihrer Situation passt.',
  },
  {
    step: 2,
    title: 'Kennenlerngespräch',
    description: 'Kostenfrei & unverbindlich per Video-Call. Wir klären Ihre Ziele und ob Bright Medical der richtige Rahmen für Sie ist. Keine Diagnose, keine Behandlung.',
  },
  {
    step: 3,
    title: 'Programmwahl',
    description: 'Sie wählen Ihr Programm. Wir besprechen transparent den Ablauf, Umfang und Ihre Investition, ganz ohne Druck.',
  },
  {
    step: 4,
    title: 'Coaching-Start',
    description: 'Ihr individueller Plan startet. Regelmäßige Coaching-Calls, strukturierte Materialien und Impulse, persönlich begleitet.',
  },
]
