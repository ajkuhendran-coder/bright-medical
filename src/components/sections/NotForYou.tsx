      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-on-scroll text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-navy mb-6">
            Dieses Programm ist nicht fuer Sie, wenn...
          </h2>
        ...
        <div className="animate-on-scroll text-center">
          <p className="text-lg text-navy font-semibold mb-6 font-[var(--font-heading)]">
            Aber wenn Sie bereit sind, Verantwortung fuer Ihre Gesundheit zu uebernehmen...
          </p>
          <button
          ...
          >
            Klingt nach mir — ich moechte ein Erstgespraech
          </button>
        </div>
      </div>
    </section>
